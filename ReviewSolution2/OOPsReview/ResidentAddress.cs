...
namespace OOPsReview.Data
{
    ...
    public struct ResidentAddress
    {
        ...
        public ResidentAddress(int Number, string Address1, string Address2, string Unit, string City, string ProvinceState)
        {
            ...
            //
            //the keyword this refereences to the instace that you are currently accessing in your program
            ...
            //for a property, one MUST use a fully implemented property with the data member, and assign the incoming value

...
namespace OOPsReview
{
    public class Employment
    {
        ...
        //An instance of this class wil lhold data about a person's employment
        //The code of this class is thge definition of that data
        ...
        //      private: only code within rhe class can alter the contents of the data
        ...
        //      within the class (readonly property); this property would ONLY have a accessor (get)
        ...
        public string Title
        {
            ...
            {
                //mutator
                //the set "coding block" will set receives an incoming value and places it into the 
                //associated data field
                //during the setting, you might wish to validated the incoming data
                //during the setting, you might wish to do some type of logical processing using the
                // data to set another field
        ...
        //using an enum for this field will automatically restrict the values this property
        ...
        public double Years
        {
            ...
            set
            {
                if (value < 0)
                {
                    throw new ArgumentOutOfRangeException($"Years value {value} is invalid. Must be greater than 0.");
                }
        ...
        //the result of creation is to ensure that the coder gets an instance in a valid "known state"

        //if your class definition has NO constructor coded, the data members and/or auto implemented
        ...
        {
            //constructor body
            //  a) empty: values will be set to C# default
            ...
            //  run your constructors when it is created.
